...
In Table~\ref{tbl:similarity-evaluation}, we show some examples~\footnote{Visit http://ssedhain.com/demos/Item-Item.html for interactive visualization} of top-5 similar items learned by I-\LinearLow model. We observe that the model
