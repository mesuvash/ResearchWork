...
In Table~\ref{tbl:similarity-evaluation}, we show some examples~\footnote{\scriptsize Download https://drive.google.com/file/d/0B-0mTXCErInJd1RUSXl3YlE4TVE/view and view it in a browser for an interactive exploration of learned item-item similarities.} of top-5 similar items learned by I-\LinearLow model. We observe that the model 
