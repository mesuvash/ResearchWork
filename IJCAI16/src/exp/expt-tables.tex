...
\begin{figure}[!ht]
  ...
  \caption{Performance of the U-\LinearLow and I-\LinearLow with the number of dimensions. [NOTE: This graph is incomplete and will be updated as soon as I get the results of the ongoing experiment.]}
...
In Table~\ref{tbl:similarity-evaluation}, we qualitatively evaluate the item-item similarity learned by the I-\LinearLow model. It shows that the I-\LinearLow model learns meaningful similarities which makes it very applicable in making similar items recommendation.
