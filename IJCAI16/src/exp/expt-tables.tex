Tables \ref{tbl:guitar-results} -- \ref{tbl:ml10m-results} summarise the results of the various methods.
...
\item Neighborhood based methods are computationally inexpensive. However, they are consistently outperformed by the linear methods in all of our dataset.  %Furthermore, user based method ran out of memory on movielens 10M dataset. Hence, neighborhood methods can run into memory related issues on a fairly dense decent sized dataset. 
