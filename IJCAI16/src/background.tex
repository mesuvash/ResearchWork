...
\todon{Some matrices are bold and others not. Please cite the precise entry in the paper of Halko where this algorithm is described.}
...
\todon{It is not good practice to start sentences with [REF]. Please reformulate like the SVD randomization [4] above.}
...
\todon{Use simpler acronyms ? Like R-SVD-1 and R-SVD-2.}